...
<body>
	...
	<div class="slider-area ">
		...
		<div class="single-slider slider-height2 d-flex align-items-center"
			data-background="${pageContext.request.contextPath}/resources/image/mmatch/mypage_mmapply.jpg">
						...
						<div class="section-title text-center">
							...
							<div class="dmoain-pricing">
								<div class="table-responsive-sm">
									 <i id="Apply" class="fas fa-running">&nbsp;&nbsp;내 신청(멘토 글 신청) 리스트 
									...
									<table>
										...
										<c:forEach var="mentor" items="${mentorApplylist}">
											<tr>
												...
												<td>
													<c:if test="${mentor.match_state == 1}">
														<div onclick="javascript:mentorCancel('${mentor.match_code}');" class="submit4">신청취소</div>
													</c:if> 
													<c:if test="${mentor.match_state != 1}">
														<div class="submit6">수락/거절</div>
													</c:if> 
												</td>
												<td><div onclick="javascript:mentorDetail('${mentor.match_code}');" class="submit5">상세보기</div></td>
											</tr>
										</c:forEach>
										</c:if>
										<c:if test="${listcount1 == 0 }">
							...
							<div class="dmoain-pricing">
								<div class="table-responsive-sm">
									<i id="Register" class="fas fa-running">&nbsp;&nbsp;내 신청(멘티 글 신청) 리스트 
									...
									<table>
										...
										<c:forEach var="mentee" items="${menteeApplylist}">
											<tr>
												...
												<td>
													<c:if test="${mentee.match_state == 1}">
														<div onclick="javascript:menteeCancel('${mentee.match_code}');" class="submit4">신청취소</div>
													</c:if> 
													<c:if test="${mentee.match_state != 1}">
														<div class="submit6">수락/거절</div>
													</c:if> 
												</td>
												<td><div onclick="javascript:menteeDetail('${mentee.match_code}');" class="submit5">상세보기</div></td>
											</tr>
										</c:forEach>
										</c:if>
										<c:if test="${listcount2 == 0 }">
  ...
  <!-- 멘티 상세보기 modal -->
   <div class="modal" id="detailMenteeModal">
	...
	<script src="${pageContext.request.contextPath}/resources/js/mmatch/mymmApplist.js"></script>
	<script>
